 ...
 */
package com.xyz.slppp.app.config.datasource;
...
@MapperScan(basePackages = {"com.xyz.slppp.app.modular.*.dao"})//, "com.xyz.slppp.app.modular.hbase.dao"})
public class MultiDataSourceConfig {
    ...
    private DruidDataSource bizDataSource(DruidProperties druidProperties, MutiDataSourceProperties mutiDataSourceProperties) {
        ...
        //phoenix
        dataSource.setMinEvictableIdleTimeMillis(60000);//1min
